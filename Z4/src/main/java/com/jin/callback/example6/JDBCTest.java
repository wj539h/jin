...
public class JDBCTest {
	...
	String createSql = "create table tbl_user (uuid bigint generated by default as identity (start with 1), name varchar(255) not null, age int not null, primary key (uuid), unique (uuid));";
    ...
    /**
     * 为通用查询动态的拼接sql的条件部分，基本思路是： 如果用户填写了相应的条件，那么才在sql中添加对应的条件
     * 
     * @param sql sql的主干部分
